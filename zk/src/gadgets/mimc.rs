...
pub fn mimc2(xl: &Scalar, xr: &Scalar, constants: &[Scalar]) -> Scalar {
    assert_eq!(constants.len(), MIMC_ROUNDS);
...
pub fn mimc1_hash<CS: ConstraintSystem>(
    cs: &mut CS,
    x: LinearCombination,
    mimc_rounds: usize,
    mimc_constants: &[Scalar],
...
pub fn mimc2_hash<CS: ConstraintSystem>(
    cs: &mut CS,
    ...
    fn test_mimc1() {
        ...
        for _ in 0..SAMPLES {
            ...
            let (proof, commitments) = {
                ...
                println!(
                    "For MiMC1 rounds {}, no of constraints is {:?}",
                    &MIMC_ROUNDS,
                    &prover.metrics()
                );
    ...
    fn test_mimc2() {
        ...
        for _ in 0..SAMPLES {
            ...
            let (proof, commitments) = {
                ...
                println!(
                    "For MiMC2 rounds {}, no of constraints is {:?}",
                    &MIMC_ROUNDS,
                    &prover.metrics()
                );
