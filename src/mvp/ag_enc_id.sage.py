...
_sage_const_7 = Integer(7); _sage_const_8 = Integer(8); _sage_const_16 = Integer(16); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_123456787654321 = Integer(123456787654321); _sage_const_10 = Integer(10); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_11 = Integer(11); _sage_const_56 = Integer(56); _sage_const_100 = Integer(100)# there must be Setup, KeyGen, Extract, Encrypt, Decrypt functions of AgEncID protocol
import time
import hashlib
...
def Decrypt(S, ID, sk_ID, Hdr, pk, pairing):
    ...
    for power, coeff in p_iS_polly.monomial_coefficients().items():
        Hp_iS += coeff * pk[power + _sage_const_1 ]    
...
def main(m: int):
    ...
    S = [_sage_const_2 , _sage_const_4 , _sage_const_9 , _sage_const_11 , _sage_const_56 ]
    Hdr, K = Encrypt(S, pk, pairing)

    K_ = Decrypt(S=S, ID=ID, sk_ID=sk_ID, Hdr=Hdr, pk=pk, pairing=pairing)

    # for (power1, coeff1), (power2, coeff2) in zip(K.coefficients(), K_.coefficients()):
    #     print(power1, coeff1)
    #     print(power2, coeff2)
    #     print("")
