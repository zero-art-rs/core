...
_sage_const_1461501624496790265145448589920785493717258890819 = Integer(1461501624496790265145448589920785493717258890819); _sage_const_1461501624496790265145447380994971188499300027613 = Integer(1461501624496790265145447380994971188499300027613); _sage_const_1208925814305217958863207 = Integer(1208925814305217958863207); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_20 = Integer(20); _sage_const_123456787654321 = Integer(123456787654321); _sage_const_10 = Integer(10)# there must be Setup, KeyGen, Extract, Encrypt, Decrypt functions of AgEncID protocol
import numpy as np
